...
export const useRepository = (owner, repo) =>
  useSelector((state) => state?.repositories?.get(`${owner}/${repo}`) || null);
export const useRepositoryLoading = (owner, repo) =>
  useSelector((state) => state?.repositories?.get(`${owner}/${repo}`).isLoading);
export const useRepositoryError = (owner, repo) =>
  useSelector((state) => state?.repositories?.get(`${owner}/${repo}`).error);
